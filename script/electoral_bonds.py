...
parties=pd.read_csv("/Users/apple/Desktop/projects/electoral_bonds/data/encashed.csv",index_col=False)

companies=pd.read_csv("/Users/apple/Desktop/projects/electoral_bods/data/purchased.csv",index_col=False)
